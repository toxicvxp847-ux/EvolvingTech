...
// AI backend with long-term memory + Developer Mode file writing (fixed version)
...
app.post("/api/chat", async (req, res) => {
  try {
    ...
    // Load past memory for continuity
...
If Mason asks for a feature or design change, reply in JSON like:
{
  "reply": "Explain what the change does.",
  "codeSuggestion": "<HTML, CSS, or JS code snippet>"
}
If he’s chatting casually, respond normally without codeSuggestion.
`;
